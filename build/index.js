...
class FitText extends React.Component {
    ...
    componentDidMount() {
        ...
        window.addEventListener('resize', lodash_debounce(this._onBodyResize, this.props.debounce));
        this._onBodyResize();
    }
    componentWillUnmount() {
        window.removeEventListener('resize', lodash_debounce(this._onBodyResize, this.props.debounce));
    }
    _getFontSize(value) {
    ...
    render() {
        return (React.createElement("div", { ref: (el) => (this.element = el), style: { fontSize: this.state.fontSize } }, this.props.children));
    }
}
